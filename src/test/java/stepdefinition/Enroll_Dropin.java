...
public class Enroll_Dropin
{
    ...
    @When("I send a POST request to enroll-child API with valid body")
    public void i_send_a_post_request_to_enroll_child_api_with_valid_body()
    {
        ...
        int childId = Integer.parseInt(ConfigReader.getProperty("child_id"));
        String startDate = ConfigReader.getProperty("start_date");
        requestBody = Pl.getEnrollChildPayload(providerId, classroomId, childId, startDate);
